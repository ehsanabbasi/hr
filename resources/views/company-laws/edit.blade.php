<x-dashboard-layout>
    <x-slot name="title">Edit Company Law Settings</x-slot>

    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
            <h1 class="text-2xl font-bold mb-6">Edit Company Law Settings</h1>
            ...
            <form method="POST" action="{{ route('company-laws.update', $companyLaw) }}">
                ...
                <div class="flex items-center justify-end">
                    <a href="{{ route('company-laws.index') }}" class="text-gray-600 mr-4">Cancel</a>
