            ...
            <form method="POST" action="{{ route('departments.update', $department) }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('description', $department->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    <label for="head_id" class="block mb-2 text-sm font-medium text-gray-700">Head of Department</label>
                ...
                <div class="flex items-center justify-end">
                    <a href="{{ route('departments.index') }}" class="text-gray-600 mr-4">Cancel</a>
